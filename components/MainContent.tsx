    ...
    <main className="flex flex-1 flex-col items-center justify-center px-4 py-12 text-center">
      ...
      <div className="w-full max-w-2xl rounded-xl bg-white/50 dark:bg-slate-800/30 backdrop-blur-lg shadow-xl p-6 sm:p-10">
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
            <button className="flex items-center justify-center w-full sm:w-auto min-w-[120px] cursor-pointer overflow-hidden rounded-xl h-12 px-6 bg-primary text-slate-50 text-base font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 transition-colors shadow-lg">
              <span className="truncate flex items-center gap-2">
                <span className="material-symbols-outlined">smart_toy</span>
                Talk to Sakhi
              </span>
            </button>
            <button className="flex items-center justify-center w-full sm:w-auto min-w-[120px] cursor-pointer overflow-hidden rounded-xl h-12 px-6 bg-slate-200 dark:bg-slate-700 text-slate-800 dark:text-slate-200 text-base font-bold leading-normal tracking-[0.015em] hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors shadow-lg">
              <span className="truncate flex items-center gap-2">
      ...
      <section className="w-full max-w-2xl mt-16 px-4 sm:px-0">
        ...
        <div className="mt-10 text-center">
            <button className="flex items-center justify-center w-full sm:w-auto min-w-[150px] cursor-pointer overflow-hidden rounded-xl h-12 px-6 bg-primary text-slate-50 text-base font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 transition-colors shadow-lg mx-auto">
                <span className="truncate flex items-center gap-2">
